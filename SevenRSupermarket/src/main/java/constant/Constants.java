...
public class Constants {
	public static final String ERRORMESSAGE="Login Alert is not displayed";
	public static final String DASHBOARDMESSAGE="dashboard is not loaded";
	public static final String USERMESSAGE="User Created Successfully";
